...
<div class="row">
    ...
    <div class="col-md-9 col-lg-8 mx-auto">
        ...
        <form method="POST" onsubmit="login()" autocomplete="on">
            <?= csrf() ?>
            ...
            <div class="form-floating mb-3">
                <input type="password" name="password" class="form-control <?= error('password', 'is-invalid') ?>" id="floatingPasswordlogin" placeholder="Password">
