...
<div class="row">
    <div class="col-auto mx-auto">
        <img src="<?= asset('login.svg') ?>" style="width: 65%;" class="d-block d-md-none img-fluid mx-auto">
    </div>
    <div class="col-md-9 col-lg-8 mx-auto">
        ...
        <form method="POST" onsubmit="login()">
            ...
            <div class="form-floating mb-3">
                ...
                <label for="floatingPasswordlogin" class="form-label"><i class="fa-solid fa-lock mx-1"></i>Kata
                    sandi</label>
