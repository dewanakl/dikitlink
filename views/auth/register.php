...
<form method="POST" onsubmit="register()" id="submit-form">
    ...
    <div class="form-floating mb-3">
        <input type="email" name="email" class="form-control <?= error('email', 'is-invalid') ?>" id="floatingEmail" placeholder="Email" value="<?= old('email') ?>" autocomplete="on" required>
    ...
    <div class="form-floating mb-3">
        <input type="password" name="password" class="form-control <?= error('password', 'is-invalid') ?>" id="floatingPassword" placeholder="Password" autocomplete="on" required>
